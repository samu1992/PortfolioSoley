...
import me1 from './ProfilePhoto2.png';
...
const About = () => {
    return (
        <div className='container_about'>
            <div className='container_about--p1 parrafo'>
            ...
            <div className='container_about--p2 parrafo'>
            ...
            <div className='container_about--p3 parrafo'>
            ...
            <div className='container_about--p4 parrafo'>
                <img src={pino} alt='miFoto' />
                <img src={flores} alt='miFoto' />
                <img src={menta} alt='miFoto' />
            </div>
            <div className='container_about--p5 parrafo'>
                <h4>Fun facts!</h4>
                <ul>
